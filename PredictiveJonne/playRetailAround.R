...
# Default path
default <- rbind(c(3.5,2),c(3.5,5.6),c(3.5,8.8),c(10,8.8),c(20,8.8),c(20,5.6),c(20,2),c(35.5,1.5),c(35.5,7),
                 c(37.5,8.8),c(37.5,12.4),c(37.5,15.3),c(37.5,18),c(37.5,21.2),c(37.5,24),c(30,24),c(20,24),
                 c(15,21.2),c(21,21.2),c(21,18),c(21,15.3),c(21,12.4),c(15,12.4),c(4,12.4),c(4,15.3))
...
repeat {
  ...
  # Create new state
  state <- moveAll(state,objects,nests,alpha,delay=0,cores=cores,reach=17,
