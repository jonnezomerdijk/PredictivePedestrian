...
objects <-            
  list(list(x=c(-.5,AAl+.5),          y=c(-.5,AAw+.5)), # space
       ...
       list(x=c(AAl-sw,AAl+.5),       y=c(2*pw,AAw)), # righ t wall shelf
...
# Default path
default <- rbind(c(3.5,2),c(3.5,5.6),c(3.5,8.8),c(10,8.8),c(20,8.8),c(20,5.6),c(15,5.6),c(3.5,5.6),c(3.5,2),
                 c(10,2),c(20,2),c(25,2),c(35.5,1.5),c(39.6,1),c(39.6,3.5),c(39.6,7),c(35.5,7),c(35.5,5.6),
                 c(30,5.6),c(20,5.6),c(20,8.8),c(25,8.8),c(37.5,8.8),c(37.5,12.4),c(37.5,15.3),c(37.5,18),c(37.5,21.2),
                 c(37.5,24),c(30,24),c(20,24),c(15,21.5),c(21,21.2),c(30,21.2),c(37.5,21.2),c(37.5,18),c(30,18),
                 c(21,18),c(21,15.3),c(30,15.3),c(37.5,15.3),c(37.5,12.4),c(30,12.4),c(21,12.4),c(15,12.4),
                 c(4,12.4),c(4,15.3),c(10,15.3),c(21,15.3),c(21,18),c(15,18),c(4,18),c(4,21.5),c(10,21.5),c(4,21.5),
                 c(4,15.3))
...
startState <- state <- list(p=p_n,v=v_n,a=a_n,r=r_n,P=P_n,group=group)
...
trace <- vector(mode="list") # Configuration before a choice + choice
...
repeat {
  ...
  # Create new state
  state <- moveAll(state,objects,nests,alpha,delay=0,cores=cores,reach=8,
                   plotSim=plotSim,usebestAngle=FALSE,
  ...
  if (N %% 3 == 0) { # nr of iterations before adding pedestrians 
    if (sum(apply(state$p,1,function(x){x[1]<10&x[2]<10})) < 8) { # add pedestrian if no one near entrance
      if (dim(state$p)[1] < capacity) { # if capacity is not reached
        ...
        state <- addPed(state,startState,p,goaltype="Ordered",pSD,groupSize,matchvPref) # add pedestrian to state
      }
    }
  }
